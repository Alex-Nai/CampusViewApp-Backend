    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthFilter) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/resource/available").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/resource/available/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/resource/type/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/resource/{id}").permitAll()
                .requestMatchers("/auth/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/resource").permitAll()
                .requestMatchers(HttpMethod.GET, "/resource/available").permitAll()
                .requestMatchers(HttpMethod.GET, "/resource/available/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/resource/type/**").permitAll()
